...
for (let i = 0; i < data.length - 1; i++) {
    ...
    if (entry1_1 || entry2_2) {
        break;
    }
}

console.log(`Values: ${entry1_1}, ${entry2_2}`, `Result: ${entry1_1 * entry2_2}`);
...
console.log(`Values: ${entry2_1}, ${entry2_2}, ${entry2_3}`, `Result: ${entry2_1 * entry2_2 * entry2_3}`);
